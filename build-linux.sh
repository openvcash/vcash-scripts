...
wget --no-check-certificate "https://openssl.org/source/openssl-1.0.2e.tar.gz"
echo "e23ccafdb75cfcde782da0151731aa2185195ac745eea3846133f2e05c0e0bff  openssl-1.0.2e.tar.gz" | sha256sum -c
